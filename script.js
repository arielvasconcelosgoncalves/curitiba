...
const countDownDate = new Date("Jul 16, 2025 10:30:00").getTime();
...
const x = setInterval(function() {
    ...
    document.getElementById("countdown").innerHTML = "Viagem: "+days + "d " + hours + "h "
    + minutes + "m " + seconds + "s ";

    // Se a contagem regressiva terminar, exibe uma mensagem
    if (distance < 0) {
        clearInterval(x);
        document.getElementById("countdown").innerHTML = "Bora para Curitiba!";
    }
}, 1000);
